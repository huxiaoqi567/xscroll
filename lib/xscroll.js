    ...
    mix(XScroll.prototype,{
        ...
        */
        ...
        _bindEvt: function() {
            ...
            renderTo.addEventListener("touchstart",function(){
                 e.preventDefault();
                self.stop();
            });
            ...
            renderTo.addEventListener("panstart",function(e){
                offset = self.getOffset();
                self.translate(offset);
                self.fire(PAN_START, {
                    offset: offset
            ...
            renderTo.addEventListener("pan",function(e){
             ...
             renderTo.addEventListener("panend",function(e){
