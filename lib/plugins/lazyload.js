 ...
 * @extends {Base}
 */
var LazyLoad = function LazyLoad(cfg) {
  LazyLoad.superclass.constructor.call(this, cfg);
  this.userConfig = Util.mix({
    imgsSelector: 'img',
    delay: 200,
    imgSetter: function imgSetter(img) {
...
Util.extend(LazyLoad, Base, {
  ...
  _filterItem: function _filterItem() {
    var self = this;
  ...
  _filterItemByNormal: function _filterItemByNormal() {
    var self = this,
        pos;
  ...
  _filterItemByInfinite: function _filterItemByInfinite() {
    var self = this,
