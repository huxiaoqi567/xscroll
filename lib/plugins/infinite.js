 ...
 * @extends {Base}
 */
var Infinite = function Infinite(cfg) {
...
Util.extend(Infinite, Base, {
  ...
  _renderUnRecycledEl: function _renderUnRecycledEl() {
    var self = this;
    var _ = self._;
  ...
  _getChangedRows: function _getChangedRows(newElementsPos) {
    var self = this;
    var changedRows = {};
  ...
  _updateByScroll: function _updateByScroll(e) {
    var self = this;
    var xscroll = self.xscroll;
    var _ = self._;
  ...
  _updateByRender: function _updateByRender(pos) {
    var self = this;
    var _ = self._;
    var xscroll = self.xscroll;
   ...
   * @return {Array}
   **/
  _computeDomPositions: function _computeDomPositions() {
    var self = this;
    var _ = self._;
    var pos = 0,
        size = 0,
   ...
   */
  getVisibleElements: function getVisibleElements(pos) {
    var self = this;
    var xscroll = self.xscroll;
    var _ = self._;
    var pos = pos === undefined ? self.isY ? xscroll.getScrollTop() : xscroll.getScrollLeft() : pos;
  ...
  _renderData: function _renderData(el, elementObj) {
    var self = this;
    if (!el || !elementObj || elementObj.style.position == 'fixed') return;
    self.userConfig.renderHook.call(self, el, elementObj);
  },
  _renderStyle: function _renderStyle(el, elementObj, useTransition) {
    var self = this;
    var _ = self._;
    if (!el) return;
  ...
  _cellEventsHandler: function _cellEventsHandler(e) {
    var self = this;
   ...
   * @return {Infinite}
   */
  insertBefore: function insertBefore(sectionId, index, data) {
    var self = this;
   ...
   * @return {Infinite}
   */
  insertAfter: function insertAfter(sectionId, index, data) {
    var self = this;
    if (sectionId === undefined || index === undefined || data === undefined) return self;
    if (!self.sections[sectionId]) {
      self.sections[sectionId] = [];
   ...
   * @return {Infinite}
   */
  append: function append(sectionId, data) {
    var self = this;
    if (!self.sections[sectionId]) {
      self.sections[sectionId] = [];
    }
   ...
   * @return {Infinite}
   */
  remove: function remove(sectionId, from, number) {
    var self = this;
    var number = number || 1;
   ...
   * @return {Infinite}
   */
  replace: function replace(sectionId, index, data) {
    var self = this;
    if (undefined === sectionId || !self.sections[sectionId]) return self;
   ...
   */
  get: function get(sectionId, index) {
