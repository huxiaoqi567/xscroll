...
Util.extend(Snap, Base, {
   ...
   * @return {Snap}
   */
  snapTo: function snapTo(col, row, duration, easing, callback) {
   ...
   * @return {Snap}
   */
  snapToCol: function snapToCol(col, duration, easing, callback) {
    var self = this;
    var xscroll = self.xscroll;
  ...
  _colChange: function _colChange(e) {
    var self = this;
   ...
   * @return {Snap}
   */
  snapToRow: function snapToRow(row, duration, easing, callback) {
    var self = this;
    var xscroll = self.xscroll;
    var userConfig = self.userConfig;
    var duration = duration || userConfig.snapDuration;
  ...
  _rowChange: function _rowChange(e) {
    var self = this;
  ...
  /*
         ...
         down  => 16;
  */
  _snapAnimate: function _snapAnimate(e) {
